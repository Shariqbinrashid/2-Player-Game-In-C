...
/*  
Contributers:  Class+Section BSCS 8-B
    		:  Shariq Bin Rashid (Cms: 242431)
                :Faizan Qazi (Cms:263118)
            
				
*/
/* About game : *Some Basic Rules are given in code. 
                *It has two mode 1) Classic Mode 2)Solid mode
				*It has two palying modes 1) 1 player mode 2) 2 player mode
